...
namespace Device.DIO
{
    ...
    public sealed class pmiMApiDefs
    {
        ...
        public const int TMC_MAX_DO = 48; // Maximum number of D/I channels
        ...
        public const int TMC_WM_INTERRUPT = (WM_USER + 2006);
        ...
        public const int emCCW = 0;
        public const int emCW = 1;
        ...
        public const int TMC_CCW = 0;  //Counter Clockwise Direction
        public const int TMC_CW = 1;  //Clockwise Direction
        ...
        public const int TMC_IHT_CALLBACK = 0;
        public const int TMC_IHT_MESSAGE = 1;
