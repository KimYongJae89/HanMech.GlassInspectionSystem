...
{
    partial class HMProgressBar
    {

        /* Implements the design mode behavior for the HMProgressBar class. */
        internal class HMProgressBarDesigner : System.Windows.Forms.Design.ControlDesigner
        {

            public HMProgressBarDesigner()
            {
            }
